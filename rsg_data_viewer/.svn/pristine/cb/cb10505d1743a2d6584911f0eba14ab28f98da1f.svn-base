...
var rsg_ui_widgets = {
	...
	set_additional_layer_wrapper_onclick_event: function(button_id, shown_layers_div_id, selection_dropdown_id)
	{
		...
		{ // get the element that was clicked:
		   ...
		   var checkbox_state = idx = selected_layer_options.indexOf( val ) 
		   ...
		   else 
		   {
			 ...
			 else toggle_additional_layer(id); // this actually frees up the memory and REMOVES the additional layer 
